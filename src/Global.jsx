...
function Global() {
  ...
  const [activar3, setActivar3] = React.useState(false);
  ...
  return (
    <>
      ...
      <div className="div-fundo-imagem">
        <div id="fundo-janela">
          {/* <h5 id="div-texto">Salão de beleza</h5> */}
          <h5 id="div-texto">
            Salão de beleza Espelho Meu <br />
            Por detrás de cada cliente, a excelência <br /> no serviço
          </h5>
          <div id="centralizarbutao">
            <Gaveta />
          </div>
          <div className="div-icon-meu">
            {/* <span id="texto-icon" >
              <HomeOutlined /> Malanje Villa Matilde
            </span>
            <span id="texto-icon" >
              <PhoneOutlined /> 928000000
            </span> */}
          </div>
        </div>

        {/* <div id="fundo-janela-3">
          
          </div> */}
      </div>

      <div className="Janela2" id="Janela2">
        <div>
          {/* <Cardhorizonatl/> */}
          <Rolagem />
        </div>
      ...
      <div className="Janela2 " id="Jn2">
        ...
        <p id="texto-paragrafo">
          ...
          toque personalizado que só o Espelho Meu pode oferecer.
          <br /> Venha conhecer o lugar onde cada cliente é tratado como uma
          obra de arte, refletindo a verdadeira essência da beleza. Afinal, quem
          é a mais bela do reino?
        </p>
      </div>
      ...
      <div className="divlayout">
        ...
        <div className="div-img2">
          <div className="div-bloco">
            ...
            <div className="bloco">
              <h6 id="h2">Trabalho</h6>
              {/* Bloco3 */}
            </div>
          </div>

          {/* <img className="img2" src={foto4} alt="ap" /> */}
        </div>
...
<div className="card-container">
   ...
   <div className="card-container-1">
          ...
          <div
            className={`card-container-1 ${activar3 ? "card-normal" : ""}`}
            onClick={handleActivar3}
          >
            <div className="card">
              <img
                alt="example"
                ...
                className={`img-card-1 ${
                  activar3 ? "img-card-activa2" : ""
                }`}
                onClick={handleActivar3}
              />
              <div className="texto-card-div">
                <h3 className="texto-card">Makeup</h3>
                <p className="texto-card1"> Ser linda em todos os lugares.</p>
              </div>
            </div>
          </div>
</div>
      ...
      <div className="Janela3" id="Jn1">
        ...
        <div className="tagCard">
          ...
          <div
            className={`card-container ${activar3 ? "card-normal" : ""}`}
            onClick={handleActivar3}
          >
            <div className="card">
              <img
      ...
      <div className="Janela2">
        ...
        <div className="div-equipa">
          ...
          <div className="Card-equipa">
            ...
            <img className="Card-img-equipa" src={Pessoa1} alt="A1" />
      ...
      <div className="Janela2">
        ...
        <div className="div-formulario-solitacao">
          <div>
            <h6 id="texto-formulario-s-1" style={{ margin: "0" }}>
              Preencha o formulário para enviar sugestões, elogios ou solicitar
              orçamento
            </h6>

            <p className="texto-formulario-s">
              De Segunda Feira à<br /> Sábado 09:00 às 20:00
            </p>
          </div>
