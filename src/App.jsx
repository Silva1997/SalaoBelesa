...
{/* grid 1 */}
      ...
      <div className="Janela2 ">
        ...
        <p id="texto-paragrafo">
          ...
          toque personalizado que só o Espelho Meu pode oferecer.<br/> Venha conhecer
            ...
            <div className="card-container">
              <div className="card">
                <img
                  alt="example"
                  src={foto2}
                  className={`img-card ${activar3 ? "img-card-activa3" : ""}`}
      ...
      <div className="Janela2">
        <h6 id="texto1">
          <span id="text-1">04.</span>Nossa Grupo{" "}
        </h6>{" "}
        <hr id="text-1_1"></hr>
